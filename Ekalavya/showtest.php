...
<script type="text/javascript">
         <!--
            function getConfirmation(){
               var retVal = confirm("Ready to Start Test ?");
               if( retVal == true ){
...
{
	echo "<tr><td align=center ><a  href=quiz.php?testid=$row[0]&subid=$subid  Onclick='return  getConfirmation();'><font size=8>$row[2]</font></a>";
}
echo "</table>";
?>
</body>
