...
<table border="0" width="100%"  cellspacing="0" cellpadding="0" background="../image/12.jpg">
<tr>
    <td width="100%" align="center"><img border="0" src="image/12.jpg" width="0" height="150"></td>
  </tr>
  <tr>
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="../img/blackbar.jpg">
  ...
  <tr>
	...
	{
	 echo "<div align=\"right\"><strong><a href=\"login.php\"><font size=6>Admin Home</font></a><font size=6>|</font><a href=\"signout.php\"><font size=6>Signout</font></a></strong></div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
